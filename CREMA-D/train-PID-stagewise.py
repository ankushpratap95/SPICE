...
def get_arguments():
    ...
    parser.add_argument('--audio_path', default='./data/CREMAD/Crema_D/AudioWAV', type=str)
    parser.add_argument('--visual_path', default='./data/CREMAD/Crema_D/', type=str)
...
if __name__ == '__main__':
    ...
    if True:
        ...
        for epoch in range(args.epochs):
            ...
            print(f"Gradient Updates in  epoch: {len(current_dataloader)}")
