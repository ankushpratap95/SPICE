...
def get_arguments():
    ...
    parser.add_argument('--data_root', default='./kinetics-dataset/k400', type=str)
...
if __name__ == '__main__':
    ...
    random_seeds = [42, 1751780633, 7, 1, 2026]

    for trial,random_seed in enumerate(random_seeds,1):
        print(f"Starting trial:{trial} with random_seed:{random_seed}")
